...
export default function QuillEditor({
    ...
    const handleImageUpload = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onload = (event) => {
            const img = `<img src="${event.target?.result}" alt="Image" style="max-width: 100%; height: auto; margin: 10px 0;" />`;
            ...
            <div className="bg-gray-100 border-b border-gray-300 p-3">
                <div className="flex flex-wrap gap-2 items-center">
                    ...
                    <select
                        ...
                        className="px-3 py-2 bg-white border border-gray-300 rounded text-sm shadow-sm"
            ...
            <div className="relative">
                {isPreview ? (
                    ...
                    <div
                        ...
                        contentEditable
                        onInput={handleInput}
                        className="p-4 min-h-80 overflow-y-auto outline-none text-gray-900 focus:ring-2 focus:ring-blue-500 focus:ring-inset"
